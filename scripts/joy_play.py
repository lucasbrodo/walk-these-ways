...
from go1_gym.utils import gamepad_reader
...
def play_go1(headless=True):
    ...
    footswing_height_cmd = 0.35
    pitch_cmd = 0.0
    roll_cmd = 0.0
    stance_width_cmd = 0.20 #0.25
    ...
    for i in tqdm(range(num_eval_steps)):
        x_vel_cmd, y_vel_cmd, yaw_vel_cmd, _ = gamepad.get_command()
        with torch.no_grad():
            actions = policy(obs)
