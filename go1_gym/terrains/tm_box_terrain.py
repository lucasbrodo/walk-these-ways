...
from go1_gym.utils.terrain import perlin
...
class TMBoxTerrain(Terrain):
    ...
    def prepare(self):
        ...
        # print("Num rows :", self.env.cfg.terrain.num_rows)
        ...
        min_friction, max_friction = self.env.cfg.normalization.ground_friction_range
        # print("Min friction : ", min_friction)
        # print("Max friction : ", max_friction)
        ...
        # print("Min Restitution : ", min_restitution)
        # print("Max Restitution : ", max_restitution)
        ...
        for i in range(self.env.cfg.terrain.num_rows):
            for j in range(self.env.cfg.terrain.num_cols):
                ...
                # print("Static friction : ", tm_params.static_friction)
                # print("Max friction : ", max_friction)
