...
class HeightfieldTerrain(Terrain):
    ...
    def prepare(self):
        ...
        hf_params.static_friction = self.env.cfg.terrain.static_friction
        hf_params.dynamic_friction = self.env.cfg.terrain.dynamic_friction
        hf_params.restitution = self.env.cfg.terrain.restitution
